...
A_max = zeros(1, length(xi_vec));
N_max = zeros(1,length(xi_vec));
E_max = zeros(1,length(xi_vec));
...
plot(xi_vec, E_max, 'color', EPScolordet, 'linewidth', 3, 'LineStyle','-');
