...
plot(d_vec, N_max, 'o-', 'LineWidth', 3, 'MarkerSize', 12, 'DisplayName', 'N_{max}')
xlabel('d values')
ylabel('Maximum values of Nutrients')
title('Maximum N vs d values')
grid on
figure
% Plot A_max vs a_values
plot(d_vec, A_max, 's-', 'LineWidth', 3, 'MarkerSize', 12, 'DisplayName', 'A_{max}')
xlabel('d values')
ylabel('Maximum values of Algae')
title('Maximum A vs d values')
grid on
figure
% Plot A_max vs a_values
plot(d_vec, E_max, 's-', 'LineWidth', 3, 'MarkerSize', 12, 'DisplayName', 'E_{max}')
xlabel('d values')
ylabel('Maximum values of EPS')
title('Maximum E vs d values')
grid on
