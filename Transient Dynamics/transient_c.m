...
c_vec = linspace(.8,10,n_amount); %Nutrient uptake by algae 
...
plot(c_vec, N_max, 'o-', 'LineWidth', 3, 'MarkerSize', 12, 'DisplayName', 'N_{max}')
xlabel('c values')
ylabel('Maximum values of Nutrients')
title('Maximum N vs c values')
grid on
figure
% Plot A_max vs a_values
plot(c_vec, A_max, 's-', 'LineWidth', 3, 'MarkerSize', 12, 'DisplayName', 'A_{max}')
xlabel('c values')
ylabel('Maximum values of Algae')
title('Maximum A vs c values')
grid on
figure
% Plot A_max vs a_values
plot(c_vec, E_max, 's-', 'LineWidth', 3, 'MarkerSize', 12, 'DisplayName', 'E_{max}')
xlabel('c values')
ylabel('Maximum values of EPS')
title('Maximum E vs c values')
grid on
